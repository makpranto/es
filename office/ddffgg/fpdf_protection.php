...
class FPDF_Protection extends FPDF{
	...
	*/
	...
	function Footer(){
		global $retail_version;
		$this->SetY(-10);
		$this->SetTextColor(0,0,0);
		$this->SetFont('Arial','I',8);
		$this->Cell(191,0.1,"",0,1,'L',1);
		$this->Cell(0,10,'Page '.$this->PageNo(). "/{nb}",0,0,'L');
		$this->SetFont('Arial','B',8);
		// $this->Cell(0,10," $retail_version",0,0,'R');
	}
	function Header(){
		include '../heart/heart.php';
		include '../heart/dsfhiusdfhui.php';
		global $db, $customer_name, $sale_id, $customer_email, $customer_phone, $fg, $currency;
		$this->Image('../img/'.$ikon,9,5,50);
		$this->SetY(10);
		$this->SetFont( 'Arial', 'B', 10 );
		$this->SetCol(0);
		$this->Ln(25);
		$this->Cell(80,0,"Quotation: $sale_id | Currency: $currency",0,0);
		$this->Ln(-30);
		$this->SetTextColor(0,0,0);

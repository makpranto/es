    ...
    */
    ...
    var createPaginator = function(self) {
        ...
        if (opt.currentPage === 1) {
          ...
          str = str.concat('<li class="page-item"><a class="page-link" style="cursor:pointer;" href="#">', opt.firstLabel, '</a></li>');
          str = str.concat('<li class="page-item"><a class="page-link" style="cursor:pointer;" href="#">', opt.prevLabel, '</a></li>');
        }
        ...
        */
        ...
        for (var i = begin; i <= end; i++) {
          if (i === opt.currentPage) {
            str = str.concat('<li class="page-item active"><a class="page-link" style="cursor:pointer;" href="#">' + i + '</a></li>');
          } else {
            str = str.concat('<li class="page-item"><a class="page-link" style="cursor:pointer;" href="#">' + i + '</a></li>')
          }
        }
        ...
        if (opt.currentPage == opt.totalPages) {
          ...
          str = str.concat('<li class="page-item"><a class="page-link" style="cursor:pointer;" href="#">', opt.nextLabel, '</a></li>');
          str = str.concat('<li class="page-item"><a class="page-link" style="cursor:pointer;" href="#">', opt.lastLabel, '</a></li>');
        }
        str = str.concat('</ul>');
